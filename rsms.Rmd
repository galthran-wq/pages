...
Можно заметить, что длина доверительного интервала сильно менялась от выборки к выборке; а при увеличении количества наблюдений с 5 до 10, интервал лишь расширился (что случилось из-за того, что в выборке оказались выбросы, $\hat{\sigma}^2=1.67$ против $\hat{\sigma}^2=5.57$).
...
Наблюдатель, который не знает, что выборка испорчена может получить неэффективные оценками свойств распределения.
