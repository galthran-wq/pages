...
Колебания длины интервала при маленьких выборках обусловлены высокой дисперсией оценки (которая стремится к нулю при $n \xrightarrow{} \infty$). Тем не менее, так мы брали доверительный интервал 3-$\sigma$, $\mu=1$ попадает интервал в среднем в 99% случаев -- вне зависимости от размера выборки.
...
Повторим операцию для размеров выборки $n=2,..,100$ и выведем все случаи, когда $\mu=1$ не попало в доверительный интервал.
